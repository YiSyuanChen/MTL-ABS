        ...
        for group in self.param_groups:
            ...
            for idx, (p, grad) in enumerate(zip(group['params'], grads)):
                ...
                if momentum != 0:
                    ...
                    param_state = self.state[idx] # NOTE: currently not support multiple param_groups
    ...
    def step(self, params, grads, closure=None, inner_step=None):
        ...
        for group in self.param_groups:
            for idx, (p, grad) in enumerate(zip(group['params'], grads)):
                ...
                #state = self.state[p]
                state = self.state[idx] # NOTE: currently not support multiple param_groups
                ...
                update_values.append(-step_size * (exp_avg/denom))
